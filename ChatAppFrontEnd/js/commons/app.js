window.app = {
	 ...
	 * netty Server URL  '
	 */
	nettyServerUrl: 'ws:///ip_address:port/ws',
	
	/**
	 * SpringBoot Server URL 
	 */
	serverUrl: 'http://ip_address:port',
	/**
	 * Image Server URL fastdfs server is 
	 * accessed by nginx.mychatapp is the group name
	 */
	imgServerUrl: 'http://ip_address:port/mychatapp/',
	
	/**
	 * justify str is empty or not 
	 * @param {Object} str
	 * true：不为空
	 * false：为空
	 */
	...
	getDateDiff: function(dateStr){
		...
		if (isNaN(dateTimeStamp)) {
		   dateTimeStamp = Date.parse(dateStr.replace(/-/g, '/').replace(/[a-z]+/gi, ' '));
		}
